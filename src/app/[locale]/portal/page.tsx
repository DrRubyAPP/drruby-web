      ...
      <div className="ufw">
        ...
        <main className="ufm">
          ...
          <div className={on("health")} id="v-health">
            <h1>My Body</h1>
            <div className="lede">
              Bring your data in. DrRuby helps you see what&rsquo;s relevant &mdash; not another
            ...
            <div className="sec">
              ...
              <div className="data-grid">
                ...
                <button className="data-btn">
                  ...
                  <span>Sleep, activity, heart data</span>
                </button>
                <button className="data-btn">
                  <span className="data-ic">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <b>Add a medical report</b>
                  <span>Physical exam, imaging, notes</span>
                </button>
                <button className="data-btn">
                  <span className="data-ic">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <b>Import a wearable summary</b>
                  <span>Ring, watch, CGM</span>
                </button>
              </div>
            </div>
            <div className="sec">
              ...
              <div className="card matter">
                <h3>1 meaningful change</h3>
                <p>Your average bedtime moved about 46 minutes later over the past 10 days.</p>
                <div className="matter-next">View why this matters &rarr;</div>
                <div className="why">
                  <span className="why-src">based on Apple Watch sleep data</span>
                  <span className="conf obs">Observed</span>
                </div>
              </div>
              <div className="card matter">
                <h3>2 stable indicators</h3>
                <p>Your resting heart rate and activity frequency have stayed steady.</p>
                <div className="matter-next">View details &rarr;</div>
                <div className="why">
                  <span className="why-src">based on Apple Watch data</span>
                  <span className="conf obs">Stable</span>
                </div>
              </div>
              <div className="card matter">
                <h3>4 items need more context</h3>
                <p>
                  Your recent LDL result can&rsquo;t yet be compared &mdash; there&rsquo;s no
                  comparable prior panel on file.
                </p>
                <div className="matter-next">Add context &rarr;</div>
                <div className="why">
                  <span className="why-src">based on your June 12 lab upload</span>
                  <span className="conf no">Not enough information</span>
                </div>
              </div>
              <div style={{ fontSize: 12.5, color: "#a89a95", marginTop: 4 }}>
                Organized by relevance, not by health domain. DrRuby surfaces what changed,
                what&rsquo;s stable, and what it can&rsquo;t yet assess &mdash; not a fixed set of
                trackers to maintain.
              </div>
            </div>
            <div className="sec">
              ...
              <div className="card">
                <div className="lab-row">
                  <div className="lab-name">LDL</div>
                  <div className="lab-val">
                    168 <span className="lab-unit">mg/dL</span>
                  </div>
                  <svg className="spark" viewBox="0 0 90 28" preserveAspectRatio="none">
                    <polyline points="0,19 22,21 45,15 68,11 90,6" fill="none" stroke="var(--p-red)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  <span className="conf pos">Possible</span>
                </div>
                <div className="cm2-note">
                  &uarr; Higher than your previous test. Only one prior comparison is available
                  &mdash; so this is context, not a conclusion. Trend shown as evidence, never as a
                  dashboard.
                </div>
              </div>
            </div>
            <div className="sec">
              <div className="sec-h">Current focus &middot; only what&rsquo;s relevant to you</div>
              <div className="card">
                <div style={{ fontFamily: "var(--p-serif)", fontSize: 19 }}>
                  Strength &amp; muscle health
                </div>
                <div style={{ fontSize: 13, color: "#999", marginTop: 4 }}>
                  Based on your stated goal. DrRuby prioritizes related information when it is
                  available, and only surfaces it when it becomes relevant &mdash; nothing is
                  collected unless you connect or add it.
                </div>
              </div>
            </div>
            <div className="sec">
              ...
              <div className="card">
                <div className="foll">
                  <span className="dot" />Add a comparable photo after August 12
                </div>
                <div className="foll">
                  <span className="dot" />Review sleep trend after 14 nights
                </div>
                <div className="foll">
                  <span className="dot" />Note how you feel 4 weeks after starting treatment
                </div>
              </div>
            </div>
            <div className="sec">
