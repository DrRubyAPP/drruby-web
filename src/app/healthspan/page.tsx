        ...
        <div className="max-w-[1100px] mx-auto py-20 px-5 md:px-10 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="hidden md:block bg-white border border-dr-border rounded-[20px] p-6 shadow-[0_4px_24px_rgba(0,0,0,0.06)]">
            ...
            <div className="border-l-3 border-l-dr-red bg-dr-red-lt rounded-r-lg py-3 px-4 text-[13px] italic text-[#a00015] leading-relaxed">
              &ldquo;Not testing your hormones — inferring their impact from
              skin, sleep, recovery, and the signals your body is already giving
              you.&rdquo;
            </div>
          </div>
        </div>
      ...
      <div className="bg-dr-red py-14">
        <div className="max-w-[1100px] mx-auto px-5 md:px-10 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:border-r md:border-white/20 md:pr-8">
            ...
            <p className="text-[15px] text-white/85 leading-relaxed">
              Every month we ask: is this tracking bringing you closer to your
              life, or replacing it?
            </p>
          </div>
          <div>
            <div className="text-base font-bold text-white mb-2">
              Science led by Charles Brenner, PhD
            </div>
            <p className="text-[15px] text-white/85 leading-relaxed">
              World&apos;s leading NAD+ researcher. Every index traceable to
              published research.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="bg-white border border-dr-border rounded-2xl py-7 px-7">
              <p className="text-lg italic text-dr-black leading-relaxed mb-4">
                ...
                <strong className="not-italic text-dr-red">
                  asked what I actually wanted to do.
                </strong>
                &rdquo;
              </p>
            ...
            <div className="bg-white border border-dr-border rounded-2xl py-7 px-7">
              <p className="text-lg italic text-dr-black leading-relaxed mb-4">
                ...
                after DrRuby showed no measurable change after 8 weeks. That
                alone paid for the whole year.&rdquo;
              </p>
              <div className="text-xs font-semibold tracking-[0.5px] uppercase text-dr-muted">
        ...
        <div className="max-w-[1100px] mx-auto px-5 md:px-10">
          <WaitlistForm
            title={
              <>
                Give your body a{" "}
                <em className="italic text-dr-red">language.</em>
              </>
            }
            ...
            concerns={[
              {
                label: "Fatigue or energy crashes during the day",
                value: "fatigue",
              },
              { label: "Sleep that doesn't feel restorative", value: "sleep" },
              {
                label: "Perimenopause or menopause symptoms",
                value: "perimenopause",
              },
              {
                label: "Slower recovery from exercise or stress",
                value: "recovery",
              },
              {
                label: "I take supplements and want to know if they work",
                value: "supplements",
              },
            ]}
            showWinning
