    ...
    <div className="max-w-[680px]">
      ...
      <div className="bg-dr-white border border-dr-border p-5 mb-5">
        ...
        <ul className="text-[13px] text-dr-ink leading-[1.8] space-y-1.5">
          <li>· A read on whether what you're feeling is a pattern or a passing week</li>
          <li>· Cross-reference with sleep, HRV, cycle, and supplement timing</li>
          <li>· One concrete next step — not a list of 10 metrics to worry about</li>
          <li>· The same "save your money" lens: what <em>not</em> to buy or try</li>
        </ul>
      </div>
