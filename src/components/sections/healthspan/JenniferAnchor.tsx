...
export default async function JenniferAnchor() {
  ...
  return (
    <div className="bg-dr-white py-10 px-10 flex items-center gap-12 border-b border-dr-border flex-col md:flex-row">
      <div className="flex-shrink-0 w-16 h-16 bg-dr-off border border-dr-border flex items-center justify-center">
        <span className="font-serif text-[26px] font-light text-dr-ink">
          JG
        </span>
      </div>
