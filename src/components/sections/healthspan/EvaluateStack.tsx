    ...
    <section className="bg-dr-off border border-dr-border py-9 px-10">
      <div className="flex items-start justify-between gap-10 flex-col md:flex-row">
        ...
        <div className="flex-1 max-w-[400px]">
          <div className="text-[12px] font-semibold tracking-[0.2em] uppercase text-dr-red mb-2.5">
            {t("eyebrow")}
          </div>
          <h2 className="font-serif text-[28px] font-light text-dr-ink leading-[1.3] mb-3.5">
            {t("title")}
          </h2>
          <p className="text-[14px] text-dr-mid leading-[1.7] mb-4.5">
            {t("desc")}
          </p>
          <div className="text-[13px] text-dr-mid leading-[1.8] mb-5">
            {bullets.map((b, i) => (
          ...
          <button
            type="button"
            className="bg-dr-red text-white border-none px-5.5 py-2.5 text-[13px] font-semibold tracking-[0.1em] uppercase cursor-pointer hover:opacity-90 transition-opacity"
          >
            {t("cta")}
          </button>
        </div>
        ...
        <div className="flex-1 bg-dr-white border border-dr-border p-5.5">
          <div className="text-[13px] font-semibold text-dr-ink mb-4 tracking-[0.05em]">
            {t("panelTitle")}
          </div>
          <div className="flex flex-col gap-2 mb-4">
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <div className="text-[12px] text-dr-mid">{item.dose}</div>
                  </div>
                  <div
                    className={`text-[12px] font-semibold ${style.text} ${style.bg} px-2 py-0.5`}
                  >
                    {style.label}
                  </div>
                </div>
            ...
            <div className="flex items-center justify-between px-3 py-2.5 bg-dr-off border border-dashed border-dr-border cursor-pointer text-dr-mid">
              <div className="text-[13px]">{t("addEntry")}</div>
              <div className="text-sm text-dr-red">+</div>
            </div>
          </div>
          {/* AI Insight */}
          <div className="bg-dr-wine p-3.5 mt-1">
            <div className="text-[12px] font-semibold tracking-[0.15em] text-white/40 uppercase mb-1.5">
              {t("assessmentLabel")}
            </div>
            ...
            <div className="flex gap-2 mt-2.5">
              <button
                type="button"
                className="bg-dr-red text-white border-none px-3.5 py-1.5 text-[12px] font-semibold tracking-[0.1em] cursor-pointer"
              >
                {t("exportBtn")}
              </button>
              <button
                type="button"
                className="bg-transparent text-white/50 border border-white/15 px-3.5 py-1.5 text-[12px] cursor-pointer"
              >
                {t("viewFullBtn")}
              </button>
            </div>
