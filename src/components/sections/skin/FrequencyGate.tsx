  ...
  return (
    <div className="bg-dr-ink border-b border-white/6 py-2.5 px-4 md:px-7 flex items-center justify-between gap-3">
      <div className="flex items-center gap-3 md:gap-5 min-w-0">
        ...
        <div className="hidden md:block text-[12px] text-white/20">|</div>
        <div className="hidden md:block text-[12px] text-white/30">{t("cycleNote")}</div>
      </div>
      <div className="flex items-center gap-2 md:gap-2.5 flex-shrink-0">
        <div className="hidden sm:block text-[12px] text-white/35 tracking-[0.08em]">
          {t("trackingMode")}
        </div>
        ...
        <div className="hidden sm:block text-[12px] text-white/20">{t("trackingOff")}</div>
      </div>
    </div>
  );
}
