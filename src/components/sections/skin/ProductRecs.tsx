      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
        {PRODUCT_RECS.map((p, i) => (
          ...
          >
            ...
            <div className="text-[15px] font-medium text-dr-ink">{p.name}</div>
            <div className="text-[14px] text-dr-mid my-1">{p.reason}</div>
            <div className="text-[14px] font-bold text-dr-red">
