  ...
  return (
    <>
      <div className="pt-5 px-4 md:px-7 bg-dr-off">
        <div className="text-[14px] font-semibold tracking-[0.2em] uppercase text-dr-red mb-3 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-dr-border mx-4 md:mx-7">
        {BRENNER_INDICES.map((idx, i) => (
          ...
          >
            <div className="text-[14px] font-semibold tracking-[0.22em] uppercase text-dr-red mb-2.5">
              {idx.eyebrow}
            </div>
            ...
            <p className="text-[15px] text-dr-mid leading-[1.7] font-light">
              {idx.desc}
            </p>
            <div className="text-[14px] mt-2 font-medium text-dr-red">
              {idx.trend.text}
            </div>
          </div>
        ))}
      ...
      <div className="mx-4 md:mx-7 mb-0 py-2.5 px-3.5 bg-[rgba(200,16,46,0.04)] border border-[rgba(200,16,46,0.1)] border-t-0">
        <span className="text-[13px] text-dr-mid">
          ⭐{" "}
