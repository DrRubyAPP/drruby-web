  ...
  return (
    <section className="bg-dr-white grid grid-cols-1 md:grid-cols-2 gap-0">
      <div className="p-16 md:px-18 border-r border-dr-border">
        ...
        <div className="font-serif text-[22px] font-light italic text-dr-ink leading-[1.6] mb-6">
          {t.rich("text", {
            em: (chunks) => <em className="italic">{chunks}</em>,
          })}
        </div>
        <div className="flex items-center gap-4">
          <div className="w-11 h-11 rounded-full flex items-center justify-center font-serif text-[18px] text-[rgba(200,16,46,0.5)] flex-shrink-0"
      ...
      <div className="p-16 md:px-18 bg-dr-off">
        <div className="font-serif text-[28px] font-light text-dr-ink mb-4 leading-[1.2]">
          {t.rich("n1Title", {
