...
export default async function DualEntry() {
  ...
  return (
    <div className="bg-dr-white border-b border-dr-border">
      {/* Bridge header */}
      <div className="text-center pt-9 px-6 md:px-10">
        <div className="text-[12px] font-semibold tracking-[0.2em] uppercase text-dr-mid mb-2.5">
          {t("eyebrow")}
        </div>
        <div className="font-serif text-[22px] md:text-[26px] font-light text-dr-ink leading-[1.3]">
          {t.rich("title", {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 mt-9 border-t-0">
        <Link
          href="/skin"
          className="relative overflow-hidden cursor-pointer flex flex-col justify-end p-7 md:p-12 no-underline text-inherit transition-all hover:brightness-97"
          style={{
            background: "linear-gradient(160deg,#F5F0EE 0%,#EDE5E0 100%)",
          }}
        >
          <div className="absolute right-8 top-8 md:right-12 md:top-12 w-[80px] h-[80px] md:w-[100px] md:h-[100px] border border-[rgba(200,16,46,0.1)] rounded-full">
          ...
          <div className="font-serif text-[30px] md:text-[38px] font-light text-dr-ink leading-[1.1] mb-3">
            {t("skinTitle")}
          </div>
        ...
        <Link
          href="/healthspan"
          className="relative overflow-hidden cursor-pointer flex flex-col justify-end p-7 md:p-12 no-underline text-inherit transition-all hover:brightness-97 md:border-l border-t md:border-t-0 border-dr-border"
          style={{
      ...
      {/* Convergence bridge */}
      <div className="bg-dr-wine py-[18px] px-6 md:px-10 flex items-center justify-center gap-4 md:gap-8 flex-wrap">
